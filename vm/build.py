...
SYMLINKS   = ['ERPAdda-Production.ova', 'ERPAdda-Dev.ova', 'ERPAdda-Vagrant.box',
	'ERPAdda-Production.ova.md5', 'ERPAdda-Dev.ova.md5', 'ERPAdda-Vagrant.box.md5']
...
def generate_symlinks():
	for file in NEW_FILES:
		if 'md5' in file:
			if 'Vagrant' in file:
				silent_remove(os.path.join(PUBLIC_DIR, 'ERPAdda-Vagrant.box.md5'))
				os.symlink(os.path.join(PUBLIC_DIR, file),
					os.path.join(PUBLIC_DIR, 'ERPAdda-Vagrant.box.md5'))
			elif 'Production' in file:
				silent_remove(os.path.join(PUBLIC_DIR, 'ERPAdda-Production.ova.md5'))
				os.symlink(os.path.join(PUBLIC_DIR, file),
					os.path.join(PUBLIC_DIR, 'ERPAdda-Production.ova.md5'))
			else: # Develop
				silent_remove(os.path.join(PUBLIC_DIR, 'ERPAdda-Dev.ova.md5'))
				os.symlink(os.path.join(PUBLIC_DIR, file),
					os.path.join(PUBLIC_DIR, 'ERPAdda-Dev.ova.md5'))
		else: # ova/box files
			if 'Vagrant' in file:
				silent_remove(os.path.join(PUBLIC_DIR, 'ERPAdda-Vagrant.box'))
				os.symlink(os.path.join(PUBLIC_DIR, file),
					os.path.join(PUBLIC_DIR, 'ERPAdda-Vagrant.box'))
			elif 'Production' in file:
				silent_remove(os.path.join(PUBLIC_DIR, 'ERPAdda-Production.ova'))
				os.symlink(os.path.join(PUBLIC_DIR, file),
					os.path.join(PUBLIC_DIR, 'ERPAdda-Production.ova'))
			else: # Develop
				silent_remove(os.path.join(PUBLIC_DIR, 'ERPAdda-Dev.ova'))
				os.symlink(os.path.join(PUBLIC_DIR, file),
					os.path.join(PUBLIC_DIR, 'ERPAdda-Dev.ova'))
